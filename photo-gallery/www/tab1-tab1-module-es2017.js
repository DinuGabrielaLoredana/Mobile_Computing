...
let Tab1Page = class Tab1Page {
    ...
    getAcceleration() {
        ...
        this.deviceMotion.getCurrentAcceleration().then((acceleration) => this.speed = acceleration, (error) => console.log(error));
    }
    watchAcceleration() {
...
//# sourceMappingURL=tab1-tab1-module-es2017.js.map