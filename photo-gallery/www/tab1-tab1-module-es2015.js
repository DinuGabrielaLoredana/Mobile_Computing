...
let Tab1Page = class Tab1Page {
    ...
    getAcceleration() {
        ...
        this.deviceMotion.getCurrentAcceleration().then((acceleration) => this.x = acceleration.x, (error) => console.log(error));
    }
    watchAcceleration() {
        // Watch device acceleration
        this.subscription = this.deviceMotion.watchAcceleration().subscribe((acceleration) => {
